...
-- CreateTable
CREATE TABLE "TelegramCouponRedemption" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "TelegramOrderFinanceAction" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "TelegramServerChangeRequest" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "TelegramPremiumSupportRequest" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "requestCode" TEXT NOT NULL,
    "status" TEXT NOT NULL,
...
CREATE TABLE "TelegramUserProfile" (
    ...
    "referralCode" TEXT,
    "referredByCode" TEXT,
    "pendingReferralCode" TEXT,
    "lastReferralAcceptedAt" DATETIME,
...
CREATE TABLE "TelegramSupportThread" (
    ...
    "firstResponseAlertSentAt" DATETIME,
    "firstResponseLastAlertAt" DATETIME,
...
-- CreateTable
CREATE TABLE "TelegramSupportReply" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "TelegramAnnouncement" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "experimentId" TEXT,
...
-- CreateTable
CREATE TABLE "TelegramAnnouncementDelivery" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "TelegramAnnouncementTemplate" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "name" TEXT NOT NULL,
    "audience" TEXT NOT NULL,
    "type" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "TelegramAnnouncementExperiment" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "name" TEXT NOT NULL,
    "status" TEXT NOT NULL DEFAULT 'DRAFT',
    "audience" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "TelegramAnnouncementExperimentVariant" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "SupportReplyTemplate" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "title" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "TelegramPremiumSupportReply" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "DynamicKeyTemplate" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "type" TEXT NOT NULL DEFAULT 'SELF_MANAGED',
...
-- CreateTable
CREATE TABLE "DynamicRoutingEvent" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "dynamicAccessKeyId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "SubscriptionPageEvent" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "accessKeyId" TEXT,
    "dynamicAccessKeyId" TEXT,
    "eventType" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "AccessDistributionLink" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "accessKeyId" TEXT,
    "dynamicAccessKeyId" TEXT,
    "token" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "AccessKeySlugHistory" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "accessKeyId" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "ServerOutageState" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "serverId" TEXT NOT NULL,
    "incidentId" TEXT,
...
-- CreateTable
CREATE TABLE "ServerOutageIncident" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "ServerOutageIncidentUpdate" (
    "id" TEXT NOT NULL PRIMARY KEY,
...
-- CreateTable
CREATE TABLE "AdminLoginRestriction" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "ip" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "DashboardSecurityProbe" (
