...
CREATE TABLE IF NOT EXISTS "TelegramUserProfile" (
    ...
    "trialMidpointReminderSentAt" DATETIME,
    "trialExpiringReminderSentAt" DATETIME,
    "trialExpiredNoticeSentAt" DATETIME,
    "trialWinbackNudgeSentAt" DATETIME,
...
CREATE TABLE IF NOT EXISTS "DeviceInstallClaim" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "accessKeyId" TEXT,
    "dynamicAccessKeyId" TEXT,
