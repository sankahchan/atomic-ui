...
async function main() {
  ...
  const commands: SmokeCommand[] = [
    ...
    { text: '/status', label: 'user /status' },
    { text: '/switchserver', label: 'user /switchserver' },
    { text: '/setup', label: 'user /setup' },
    { text: '/referral', label: 'user /referral' },
    ...
    { text: '/status', label: 'admin /status', admin: true },
    { text: '/expiring', label: 'admin /expiring', admin: true },
  ];
