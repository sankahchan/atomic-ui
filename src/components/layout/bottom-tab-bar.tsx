        ...
        {primaryDashboardNavItems.map((tab) => {
          ...
          return (
            <Link
              ...
              href={tab.href}
              className={cn(
                'flex min-w-0 flex-col items-center justify-center gap-1 rounded-[1.45rem] px-1 py-2 text-[10px] transition-all duration-200',
                active
            ...
            >
              ...
              <span className={cn('line-clamp-1 leading-none transition-opacity', active ? 'opacity-100' : 'opacity-80')}>
                {t(tab.labelKey)}
              </span>
            </Link>
          );
