...
export const telegramSalesPlanSchema = z.object({
  ...
  serverSwitches: z.number().int().default(3), // -1 for unlimited
  badge: z.enum(['None', 'Popular', 'Best Deal']).optional().nullable().default('None'),
  planCategory: z.enum(['Flash', 'Season', 'Dynamic', 'Trial']).default('Flash'),
  ...
  return [
    {
      ...
      localizedLabels: { my: 'Free Trial / ၂ ရက် / 5 GB' },
      priceAmount: 0,
      priceCurrency: 'MMK',
    ...
    },
    {
      ...
      serverSwitches: -1,
      badge: 'None',
      planCategory: 'Dynamic',
      durationLabel: '1 Month',
    },
    {
      code: '2m_300gb_dynamic',
      enabled: true,
    ...
    },
    {
      ...
      localizedLabels: {
        en: 'Premium / 6 Months / Unlimited (Legacy)',
        my: 'Premium / ၆ လ / Unlimited (Legacy)',
      },
      priceAmount: null,
      priceCurrency: 'MMK',
      priceLabel: '',
    ...
    },
    {
      ...
      localizedLabels: {
        en: 'Premium / 3+ Months / Unlimited (Legacy)',
        my: 'Premium / ၃ လနှင့်အထက် / Unlimited (Legacy)',
      },
      priceAmount: null,
      priceCurrency: 'MMK',
      priceLabel: '',
